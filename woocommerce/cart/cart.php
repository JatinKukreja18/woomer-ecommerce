...
<div class="page-title">
	Here are the things in your bag!
</div>
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	<?php do_action( 'woocommerce_before_cart_table' ); ?>

	<div class="wm-cart-container">
		...
		<div>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					?>
					<div class="woocommerce-cart-form__cart-item wm-cart-row row <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<div class="col-md-4 offset-1 wm-cart-product-details">
						...
						<div class="col-md-4 wm-cart-product-details">
...
<div class="cart-recommendations">
	<h3 class="wm-section-title">Recommendations</h3>
	<div class="row">

	<?php

		$args = array( 'post_type' => 'product', 'stock' => 1, 'posts_per_page' => -3,'product_cat' => 'accessories,care', 'orderby' =>'date','order' => 'ASC' );
